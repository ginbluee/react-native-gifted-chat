...
import { Platform, StyleSheet, View, SafeAreaView, KeyboardAvoidingView, Dimensions } from 'react-native';
    ...
    if (this.state.isInitialized === true) {
      ...
      return (<Wrapper style={styles.safeArea}>
        <ActionSheetProvider ref={(component) => (this._actionSheetRef = component)}>
          <View style={[styles.container, this.props.xxx]} onLayout={this.onMainViewLayout}>
            {this.renderMessages()}
